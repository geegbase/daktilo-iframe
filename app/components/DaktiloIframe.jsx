...
const slideData = [
  ...
  },
  {
    ...
    href: "https://balikesirhalkinsesi.com/haber/17401279/balikesir-valisi-ismail-ustaoglu",
    avatar: "/img/ismail-ustaoglu.png",
    alt: "İsmail Ustaoğlu kimdir?",
  },
  {
    title: "Ali Taylan Öztaylan",
    href: "https://balikesirhalkinsesi.com/haber/15875167/ak-parti-balikesir-milletvekili-ali-taylan-oztaylan",
    avatar: "/img/3-ali-taylan-oztaylan.png",
    alt: "Ali Taylan Öztaylan kimdir?",
  },
  {
    title: "Mustafa Canbey",
    href: "https://balikesirhalkinsesi.com/haber/15875978/ak-parti-balikesir-milletvekili-mustafa-canbey",
    avatar: "/img/4-mustafa-canbey.png",
    alt: "Mustafa Canbey kimdir?",
  },
  {
    title: "İsmail Ok",
    href: "https://balikesirhalkinsesi.com/haber/15875738/ak-parti-balikesir-milletvekili-ismail-ok",
    avatar: "/img/5-ismail-ok.png",
    alt: "İsmail Ok kimdir?",
  },
  {
    title: "Belgin Uygur",
    href: "https://balikesirhalkinsesi.com/haber/15875447/ak-parti-balikesir-milletvekili-belgin-uygur",
    avatar: "/img/6-belgin-uygur.png",
    alt: "Belgin Uygur kimdir?",
  },
  {
    title: "Cavit Erkılınç",
    href: "https://balikesirhalkinsesi.com/haber/15874956/basin-ilan-kurumu-genel-muduru-cavit-erkilinc",
    avatar: "/img/7-cavit-erkilinc.png",
    alt: "Cavit Erkılınç kimdir?",
  },
  /* {
    title: "Yücel Yılmaz",
    href: "https://balikesirhalkinsesi.com/haber/15874759/balikesir-buyuksehir-belediye-baskani-yucel-yilmaz",
    avatar: "/img/8-yucel-yilmaz.png",
    alt: "Yücel Yılmaz kimdir?",
  }, */
  {
    title: "Yücel Oğurlu",
    href: "https://balikesirhalkinsesi.com/haber/15874526/balikesir-universitesi-rektoru-yucel-ogurlu",
    avatar: "/img/9-yucel-ogurlu.png",
    alt: "Yücel Oğurlu kimdir?",
  },
  /* {
    title: "Hasan Avcı",
    href: "https://balikesirhalkinsesi.com/haber/15874230/altieylul-belediye-baskani-hasan-avci",
    avatar: "/img/10-hasan-avci.png",
    alt: "Hasan Avcı kimdir?",
  }, */
  /* {
    title: "Dinçer Orkan",
    href: "https://balikesirhalkinsesi.com/haber/15874123/karesi-belediye-baskani-dincer-orkan",
    avatar: "/img/11-dincer-orjan.png",
    alt: "Dinçer Orjan kimdir?",
  }, */
  {
    title: "Rahmi Kula",
    href: "https://balikesirhalkinsesi.com/haber/15873833/balikesir-ticaret-odasi-baskani-rahmi-kula",
    avatar: "/img/12-rahmi-kula.png",
    alt: "Rahmi Kula kimdir?",
  },
  {
    title: "Nazmi Yarış",
    href: "https://balikesirhalkinsesi.com/haber/15873612/balikesir-sanayi-odasi-baskani-nazmi-yaris",
    avatar: "/img/13-nazmi-yaris.png",
    alt: "Nazmi Yarış kimdir?",
  },
  {
    title: "Mehmet Çetin",
    href: "https://balikesirhalkinsesi.com/haber/15873138/balikesir-ticaret-borsasi-baskani-mehmet-cetin",
    ...
    <>
      ...
      >
        {slideData.map((slide, index) => {
          ...
          return (
            <Carousel.Slide className={classes.container} key={index}>
              <UserInfoAction
                title={title}
                avatar={avatar}
                href={href}
